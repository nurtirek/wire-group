...
(() => {
  ...
  const i18n = {
    en: {
      ...
      "ca-onb-heading": "Two keys. Under a minute.",
      "ca-onb-sub": "No installs, no app store. Call Analytics lives inside Telegram and connects to Binotel with two API keys.",
      "ca-step1-title": "Open the bot",
      "ca-step1-body": "Launch @binotelanalyzebot in Telegram and tap to open the Mini App.",
      "ca-step2-title": "Binotel Key + Secret",
      "ca-step2-body": "Paste your Binotel API Key and Secret (from your Binotel cabinet → API).",
      "ca-step3-title": "That's it",
      "ca-step3-body": "The bot analyses last night's calls automatically. Open \"Yesterday\" and read the summary.",
      ...
      "ca-open-sub": "Two keys to connect. Works in any Telegram client. Binotel only.",
      "ca-cta-channel": "Telegram Mini App",
      "ca-cta-massive": "Open in Telegram",
    ...
    ru: {
      ...
      "ca-onb-heading": "Два ключа. Меньше минуты.",
      "ca-onb-sub": "Без установок и магазинов приложений. Call Analytics живёт внутри Telegram и подключается к Binotel двумя API-ключами.",
      "ca-step1-title": "Открой бота",
      "ca-step1-body": "Запусти @binotelanalyzebot в Telegram и нажми, чтобы открыть Mini App.",
      "ca-step2-title": "Ключ + Секрет Binotel",
      "ca-step2-body": "Вставь свои Binotel API Key и Secret (из кабинета Binotel → API).",
      "ca-step3-title": "Готово",
      "ca-step3-body": "Бот сам разбирает звонки за прошлую ночь. Открой «Вчера» и читай сводку.",
      ...
      "ca-open-sub": "Два ключа для подключения. Работает в любом Telegram. Только Binotel.",
      "ca-cta-channel": "Telegram Mini App",
      "ca-cta-massive": "Открыть в Telegram",
