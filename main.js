...
(() => {
  ...
  const i18n = {
    en: {
      ...
      "brand-cta-2": "Contact",
      "manifesto-kicker": "— What we do · 01",
      "manifesto-1": "We build Telegram Mini Apps",
      "manifesto-2": "that replace the laptop",
      "manifesto-3": "for restaurants and call-centers.",
      "manifesto-foot": "3 live products · Almaty · shipping since 2026",
      ...
      "approach-kicker": "— Under the hood",
      "approach-title-1": "Real integrations,",
      "approach-title-2": "not mockups.",
      "p1-num": "Integration",
      "p1-name": "iiko REST 9.x",
      "p1-body": "Direct connection to the POS. Revenue, invoices and cash shifts come straight from iiko — no manual exports.",
      "p2-num": "Intelligence",
      "p2-name": "Claude AI",
      "p2-body": "Reads supplier invoices from a photo and posts them into iiko in seconds. Scores call-center conversations overnight.",
      "p3-num": "Channel",
      "p3-name": "Telegram",
      "p3-body": "No installs, no app store, no passwords. Works on any phone your team already carries.",
    ...
    ru: {
      ...
      "manifesto-kicker": "— Чем мы заняты · 01",
      "manifesto-1": "Мы делаем Telegram Mini Apps,",
      "manifesto-2": "которые заменяют ноутбук",
      "manifesto-3": "ресторанам и колл-центрам.",
      "manifesto-foot": "3 живых продукта · Алматы · выпускаем с 2026",
      ...
      "approach-kicker": "— Под капотом",
      "approach-title-1": "Настоящие интеграции,",
      "approach-title-2": "не муляжи.",
      "p1-num": "Интеграция",
      "p1-name": "iiko REST 9.x",
      "p1-body": "Прямое подключение к кассе. Выручка, накладные и кассовые смены приходят из iiko напрямую — без ручных выгрузок.",
      "p2-num": "Интеллект",
      "p2-name": "Claude AI",
      "p2-body": "Читает накладные поставщиков с фото и проводит их в iiko за секунды. За ночь оценивает звонки колл-центра.",
      "p3-num": "Канал",
      "p3-name": "Telegram",
      "p3-body": "Без установки, App Store и паролей. Работает на любом телефоне, который уже есть у команды.",
      ...
      "product-sub": "Аналитика iiko в кармане. Без ноутбука, без логинов, без десктопа. Открыл Telegram — видишь выручку, средний чек, накладные и кассовые смены. AI-аналитик подскажет, что не так с днём, простым языком.",
